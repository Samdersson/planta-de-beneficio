...
function obtenerSiguienteConsecutivoPreview($mysqli, $tipo_animal) {
    $anio_actual = date('Y');
...
// Manejar solicitud GET para preview
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['tipo_animal'])) {
    $tipo_animal = $_GET['tipo_animal'];
    try {
        $resultado = obtenerSiguienteConsecutivoPreview($conexion, $tipo_animal);
